...
class SkillLevelsControllerTest < ActionController::TestCase
  ...
  test "should create skill_level" do
    assert_difference('SkillLevel.count') do
      post :create, skill_level: { maximum_years: @skill_level.maximum_years, minimum_years: @skill_level.minimum_years, name: @skill_level.name }
    end
  ...
  test "should update skill_level" do
    patch :update, id: @skill_level, skill_level: { maximum_years: @skill_level.maximum_years, minimum_years: @skill_level.minimum_years, name: @skill_level.name }
    assert_redirected_to skill_level_path(assigns(:skill_level))
  end
